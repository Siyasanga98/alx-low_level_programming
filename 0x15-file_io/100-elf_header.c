 ...
 * @e_ident: array containing the ELF magic number
 *
 * Description: Prints the ELF data encoding based on the value in e_ident[EI_DATA].
 */
void print_data(unsigned char *e_ident)
{
        printf("Data:    ");
 ...
 * @e_ident: array containing the ELF magic number
 *
 * Description: Prints the ELF version based on the value in e_ident[EI_VERSION].
 */
void print_version(unsigned char *e_ident)
{
 ...
 * @e_ident: array containing the ELF magic number
 *
 * Description: Prints the ABI Version based on the value in e_ident[EI_ABIVERSION].
 */
void print_osabi(unsigned char *e_ident)
{
 ...
 *
 * Description: Opens the ELF file, reads the ELF header, and prints the information.
 */
